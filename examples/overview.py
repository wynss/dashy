    ...
    match tab_id:
        case 'plots':
            return dc.container([
                dc.row([
                    dc.graph("my-graph-1",
                             figure=px.scatter(DF_IRIS, x="sepal_width", y="sepal_length", title="Scatter plot",
                                               color="species",
        ...
        case 'ui-components':
            return dc.container([
                ...
                dc.row([
                    ...
                    dc.slider('my-slider', title="A range slider with tooltip", min=0, max=100,
                              step=10, tooltip=True, tooltip_always_visible=True, value=[20, 50])
                ], margin=0),
                dc.row([
